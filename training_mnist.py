...
# 2. Modelin Tanımlanması (padding='same' eklendi)
model = Sequential([
...
model.save("mnist_model_with_padding.keras")
print("\nModel başarıyla eğitildi ve 'mnist_model_with_padding.keras' dosyası olarak kaydedildi!")
